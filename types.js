  ...
  baseDeclarations: function (models) {
    ...
    // END MODEL DEFINITION
      ...
      declare interface BaseDbo <modelProps, instance> {
        ...
        sum: (numericalKey: string, filterParams:ModelFindParams<modelProps> | OtherModelFindParams<modelProps>) => number;
        avg: (numericalKey: string, filterParams:ModelFindParams<modelProps> | OtherModelFindParams<modelProps>) => number;
    ...
    // These are the methods of an Object constructor eg. UserObject.findOne({id})
      declare interface BaseObject <modelProps, instance> {
         ...
         * 
         **/
        onDbConnect(dbConnection: Sails.ManagerInstance): Promise<void>;
        /**
